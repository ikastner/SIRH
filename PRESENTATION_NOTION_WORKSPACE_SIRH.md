...
├──────────────────────────────────────────────────────┤
│  EspaceUnifie_SIRH                                  │
│  ├── Pages (Accueil, Applications, TDB)            │
│  └── Layout (Navbar, Footer, Modales)              │
│                                                      │
│  ┌────────────────────────────────────────┐        │
│  │  Modules Métier                        │        │
│  ├────────────────────────────────────────┤        │
...
│  🔧 BACKEND (Convertigo)                             │
├──────────────────────────────────────────────────────┤
│  Connecteurs SQL (à configurer)                     │
│  ├── Connecteur BDD SIRH                            │
│  └── Transactions SQL (CRUD)                        │
│                                                      │
│  Séquences (Business Logic)                         │
│  ├── Badge : save_badge_request, get_badge_request │
│  ├── HeureSup : save_heure_sup, validate_heure_sup │
│  └── User : get_user_context, get_notifications    │
└───────────────────┬──────────────────────────────────┘
                    │
                    ▼
┌──────────────────────────────────────────────────────┐
...
│  🔐 AUTHENTIFICATION                                 │
├──────────────────────────────────────────────────────┤
│  ANAIS (Système authentification URSSAF)            │
│  ├── SSO                                            │
│  ├── Gestion des rôles (Agent, Manager, RH)        │
│  └── Permissions                                    │
└──────────────────────────────────────────────────────┘
```
